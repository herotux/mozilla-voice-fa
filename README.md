...
﻿برای کمک به پروژه متن باز  common](https://voice.mozilla.org/) voiceشرکت موزیلا] ما نیاز به جملاتی داریم که بعدا توسط دیگر فارسی زبان ها ضبط بشه و به دیتابیس اضافه بشه چند نکته در این مورد وجود داره که حتما باید رعایت بشه.
